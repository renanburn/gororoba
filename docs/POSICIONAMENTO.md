...
1. O recorte. A lista de sinais foi escolhida pra pegar slop sem pegar voz. Qualquer um
...
- O fixture anti-viés. `tests/voz-limpa.md` é um texto de voz real (mineirês, fala
  falada, frase curta) que tem que passar com zero alerta. O CI quebra se algum sinal
...
desligarem eles. O gororoba responde outra pergunta: "este texto tem sinal de slop?".
