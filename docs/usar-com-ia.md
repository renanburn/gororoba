...
Se é chat puro (Claude no navegador, ChatGPT, Gemini, o que for), a IA não roda o Vale. Ela aplica a régua como prompt. Funciona pra experimentar, mas é uma aproximação: pode escapar de um tell ou marcar um a mais. Pra resultado que você cita, roda o Caminho 1.
